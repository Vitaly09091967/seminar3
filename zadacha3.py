...
# буквы оцениваются так:А, В, Е, И, Н, О, Р, С, Т – 1 очко; Д, К, Л, М, П, 
# У – 2 очка;Б, Г, Ё, Ь, Я – 3 очка;Й, Ы – 4 очка;Ж, З, Х, Ц, Ч – 5 очков;Ш, 
# Э, Ю – 8 очков;Ф, Щ, Ъ – 10 очков.
...
print(f"Стоимость слова {word}: {sum} очков.")